...
VsJetTauIDCut = Producer(
    name="VsJetTauIDCut",
    call="physicsobject::tau::CutUChar_tID({df}, {output}, {input}, {vsjet_tau_id_bit})", # in Nano V11 the working points are no long saved as bit
...
VsElectronTauIDCut = Producer(
    ...
    call="physicsobject::tau::CutUChar_tID({df}, {output}, {input}, {vsele_tau_id_bit})", # in Nano V11 the working points are no long saved as bit
...
VsMuonTauIDCut = Producer(
    name="VsMuonTauIDCut",
    call="physicsobject::tau::CutUChar_tID({df}, {output}, {input}, {vsmu_tau_id_bit})", # in Nano V11 the working points are no long saved as bit
