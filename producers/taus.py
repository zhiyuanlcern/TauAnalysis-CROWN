...
TauPtCorrection_eleFake = Producer(
    ...
    call='physicsobject::tau::PtCorrection_eleFake({df}, {output}, {input}, "{tau_ES_sf_file}", "{tau_ES_json_name}", "{tau_id_algorithm}", "{tau_ES_wp}", "{tau_ES_wp_VSe}", "{tau_elefake_es_DM0_barrel}", "{tau_elefake_es_DM1_barrel}", "{tau_elefake_es_DM0_endcap}", "{tau_elefake_es_DM1_endcap}")',
    input=[
        nanoAOD.Tau_pt,
        nanoAOD.Tau_eta,
        nanoAOD.Tau_decayMode,
...
TauPtCorrection_muFake = Producer(
    ...
    call='physicsobject::tau::PtCorrection_muFake({df}, {output}, {input}, "{tau_ES_sf_file}", "{tau_ES_json_name}", "{tau_id_algorithm}","{tau_ES_wp}", "{tau_ES_wp_VSe}", "{tau_mufake_es}")',
    input=[
...
TauPtCorrection_genTau = Producer(
    ...
    call='physicsobject::tau::PtCorrection_genTau({df}, {output}, {input}, "{tau_ES_sf_file}", "{tau_ES_json_name}", "{tau_id_algorithm}","{tau_ES_wp}", "{tau_ES_wp_VSe}", "{tau_ES_shift_DM0}", "{tau_ES_shift_DM1}", "{tau_ES_shift_DM10}", "{tau_ES_shift_DM11}")',
    input=[
